...
contact=Image.new('RGB',(1920,1180),(25,28,30));draw=ImageDraw.Draw(contact);font=ImageFont.truetype('C:/Windows/Fonts/segoeui.ttf',25)
for i,name in enumerate(['01_Entrance','02_Commons','03_iLab']):
...
draw.text((1000,680),'CAMPUS CENTER',font=ImageFont.truetype('C:/Windows/Fonts/segoeui.ttf',44),fill='white')
draw.multiline_text((1000,765),'Cycles architectural studies\n1920 x 1080 | 256 sample cap\nRTX 4090 CUDA\nPacked Blender scene + EXR passes',font=font,fill=(188,198,207),spacing=18)
contact.save(R/'stills/Three_Views.jpg',quality=95)
