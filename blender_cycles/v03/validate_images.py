...
contact=Image.new('RGB',(1920,1770),(25,28,30));draw=ImageDraw.Draw(contact);font=ImageFont.truetype('C:/Windows/Fonts/segoeui.ttf',25)
for i,name in enumerate(['01_Entrance','02_Commons','03_iLab','04_Gallery','05_Printer_Detail','06_Entrance_Planting']):
...
contact.save(R/'stills/Six_Views.jpg',quality=95)
