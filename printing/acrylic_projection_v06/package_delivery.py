...
for r in rooms:
 ...
 prompt=(d/'H3_Loop_Prompt.txt').read_text();assert all(k in prompt for k in ['subject_definitions:','summary:','retention_analysis:','detailed_description:','overall_soundscape:','non_diegetic_music:'])
 cards.append(f'<article><h2>{n} · {html.escape(r["name"].title())}</h2><a href="{n}/Topdown_Black.png"><img loading="lazy" src="{n}/Topdown_Black.png" alt="Top-down room {n}"></a><p><a href="{n}/References.html">Numbered H3 reference pack</a> · <a href="{n}/H3_Loop_Prompt.txt">12-second walking prompt</a><br><a href="{n}/Topdown_Alpha.png">Transparent</a> · <a href="{n}/Room_Mask_1024.png">Mask</a> · <a href="{n}/Room_3D.png">3D cutaway</a></p></article>')
