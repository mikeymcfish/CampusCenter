...
R=Path(__file__).parent;sys.path.insert(0,str(R.parent/'tmp/cadpackages'))
import numpy as np
...
out=R/'Campus_Center_Ground_Furnished_1_87p5.step';w=STEPControl_Writer();assert w.Transfer(shape,STEPControl_AsIs)==IFSelect_RetDone;assert w.Write(str(out))==IFSelect_RetDone
